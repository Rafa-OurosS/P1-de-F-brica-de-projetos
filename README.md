...
Estando encarregado da parte de desenvolver a interface, foi necessário ter bastante atenção aos detalhes e empatia pelo usuário final. Boa parte dos desafio veio de alinhar o design com o perfil dos usuários e balancear isso com as opiniões e visões do próprio grupo, que em varias vezes tinham opiniões contrastantes, e ouvir cada opinião e encontrar o equilibrio ideal entre cada uma para aplicar no trabalho provou-se um grande desafio por sí só. Alinhar o design com o público alvo, que em sua maioria possui pouca familiaridade com tecnologia também provou-se um desafio interessante, pois exigiu a criação de uma interface intuitiva, simples, funcional, claro que sem deixar de lado a usabilidade e estética.

Um fator de destaque é a importância de ouvir o stakeholder e compreender seus próprios desafios de forma prática, utilizando princípios de UX/UI como affordance, cores com propósito e uma hierarquia visual clara. Também enfrentei obstáculos técnicos com o uso do Figma, esse tendo sido meu primeiro contato com a plataforma, especialmente na prototipação rápida e organização de elementos visuais, mas esses desafios me ajudaram a aprimorar minhas habilidades com ferramentas de design.

Fora que, a coleta constante de feedback do cliente provou-se essencial para ajustar a interface ao longo do tempo e evitar retrabalhos. Com isso, desenvolvi não só minhas habilidades técnicas, mas também minha capacidade de comunicação com o time e com o cliente, entendendo que o sucesso de um projeto depende muito da colaboração e da clareza nas trocas.

No geral, o processo provou-se uma experiência extremamente enriquecedora, pois me proporcionou um aprendizado prático sobre como projetar interfaces centradas no usuário e como transformar necessidades reais em soluções digitais acessíveis.
